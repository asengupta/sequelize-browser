...
var Utils             = require("./utils")
  , DAOFactory        = require("./extensions/dao-factory-q")
  , DataTypes         = require('./data-types')
  , DAOFactoryManager = require("./dao-factory-manager")
  , Migrator          = require("./migrator")
  , QueryInterface    = require("./query-interface")
  , ConnectorManager = require("./dialects/generic-mysql/connector-manager");
...
module.exports = (function() {
  ...
  */
  var Sequelize = function(database, username, password, options) {
    ...
    // var ConnectorManager = require("./dialects/mysql/connector-manager")
