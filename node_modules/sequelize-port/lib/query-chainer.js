...
var CustomEventEmitter = require("./emitters/custom-event-emitter");
...
module.exports = (function() {
  ...
  QueryChainer.prototype.run = function() {
    var self = this
    console.log("CEE=" + CustomEventEmitter)
    this.eventEmitter = new CustomEventEmitter(function() {
  ...
  QueryChainer.prototype.runSerially = function(options) {
    ...
    this.eventEmitter = new CustomEventEmitter(exec)
    return this.eventEmitter.run()
  }
