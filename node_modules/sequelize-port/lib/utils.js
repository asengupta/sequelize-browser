...
var SqlString = require("./SqlString")
  , connection = {escape: function(s) {return SqlString.escape(s);}, replace: function(s) {return this;}}
  , util       = require("npm-loader!util")
  , DataTypes  = require("./data-types")
  , EventEmitter = require('npm-loader!events');

var Utils = module.exports = {
  _: (function() {
    var _  = require("npm-loader!underscore")
  ...
  addEventEmitter: function(_class) {
    util.inherits(_class, EventEmitter)
  },
  TICK_CHAR: '`',
  addTicks: function(s) {
