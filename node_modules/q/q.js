...
// of the event loop.
var nextTick;
if (typeof process !== "undefined" && process && process.nextTick !== undefined) {
    console.log("In node!!!");
    // node
    ...
    console.log("In a modern browser");
 ...
 *
 *      var readFile = require("npm-loader!fs").readFile;
...
exports.outer = function() {console.log("Tralalala");}
/**
 * Calls a method of a Node-style object that accepts a Node-style
